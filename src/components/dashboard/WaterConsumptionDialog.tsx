...
const WaterConsumptionDialog: React.FC<WaterConsumptionDialogProps> = ({ 
  ...
  // Load water amount from local storage
  useEffect(() => {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md p-0 overflow-hidden">
        <div className="relative h-96 bg-gradient-to-b from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/30">
          ...
          >
            ...
            <div className="absolute -top-4 left-0 right-0 h-4">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320" className="absolute bottom-0" style={{marginBottom: '-1px'}}>
          ...
          <div className="relative z-10 flex flex-col items-center justify-center h-full p-6">
            ...
            <div className="text-6xl font-bold mb-2 transition-all duration-300" style={{ transform: addingWater ? 'scale(1.1)' : 'scale(1)' }}>
              {waterAmount} <span className="text-2xl">ml</span>
            </div>
            
            <div className="text-lg mb-6">{percentage}% de {goalAmount}ml</div>
            ...
            <div className="flex items-center gap-4 mb-6">
              ...
              <div className="text-2xl font-medium w-24 text-center">
                {selectedAmount} ml
              </div>
            ...
            <div className="flex gap-3 mb-6">
              {quickAmounts.map(amount => (
                <Button
                  key={amount}
                  variant="outline"
                  className={`px-4 py-2 rounded-full ${selectedAmount === amount ? 'bg-blue-500 text-white' : ''}`}
            ...
            <Button 
              size="lg"
              className="bg-blue-600 hover:bg-blue-700 rounded-full px-8 py-6 text-lg font-medium"
        ...
        {/* Bottom Navigation Tabs (simplified for now) */}
